        ...
        response.forEach(function(value){
            ...
            <div class="homeBox">
                <div class="homeBox__visual">
                    ...
                    <button class="see__description" onclick="seeDescription('${value._id}')" >
                        <p>
                ...
                <div class="homeBox__description">
                    ...
                    <span class="addCart" onclick="addCart('${value._id}', '${value.name}', '${value.price}')">
...
function seeDescription(idProduct) {
    window.location.href = "http://localhost/JWDP5/product?id=" + idProduct;
}
